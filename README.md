# Çok kullanılmayan - bilinmeyen Linux Komutları
## Giriş
...
## Linux Komutları: Herkes İçin

Son zamanlarda "Bilmeniz Gereken 20 Linux Komutu" veya "Linux Hayatta Kalma Rehberi" gibi birçok makale gördüm. Ancak bunların çoğu ls veya echo gibi komutları gösteren başlangıç seviyesinde yazılar. Sanırım çoğunuz temel komutları zaten biliyorsunuz.
